  ...
  return (
    <main className="px-32 mt-6">
      ...
      <Section titulo="Sobre a Base de Dados">
        <p className="">
          O roteiro de PyTorch de deep learning foi desenvolvido utilizando a
      ...
      <Section titulo="Sobre o Desempenho de Treino no PyTorch">
      ...
      <Section titulo="Sobre a Predição no PyTorch">
