...
export default function Home() {
  ...
  return (
    <main className="altura-main flex flex-col justify-start items-center w-full pt-3 pb-5" >
      <h1 className="text-2xl mb-2">Escolha qual o estudo que deseja ver !</h1>
      <Menu.Card>
        {Estudos.map((value, index) => {
          return (
            <Menu.Item nome={value.nome} rota={value.rota} key={index} />
          );
        })}
      </Menu.Card>
    </main>
